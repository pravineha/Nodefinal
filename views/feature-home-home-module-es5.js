(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["feature-home-home-module"], {
    ...
    function A4C(module, __webpack_exports__, __webpack_require__) {
      ...
      var _client_list_client_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      HomeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]],
        exports: []
      })], HomeModule);
      /***/
    },
    ...
    /***/
    function Adbd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(apollo, modalService) {
        ...
        _createClass(HomeComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.apollo.watchQuery({
              query: apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject())
            }).valueChanges.subscribe(function (result) {
              console.log("RESULT", result);

              if (result.data && result.data.industries) {
                _this.industryList = result.data.industries;
                _this.industryListFetch = 1;
              } else {
                _this.industryListFetch = -1;
              }
            });
          ...
          key: "openClientList",
          value: function openClientList(industryId, industryName) {
            var clientmodal = this.modalService.open(_client_list_client_list_component__WEBPACK_IMPORTED_MODULE_6__["ClientListComponent"], {
              size: 'lg'
            });
    ...
    /***/
    function G3UL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _client_list_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ClientListComponent = /*#__PURE__*/function () {
        function ClientListComponent(apollo, router, modalService) {
        ...
        _createClass(ClientListComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var industryId = this.industryId.toString();
            var query = "{\n      getBussinessesById(industryId:\"".concat(industryId, "\"){\n        name,\n        id,\n        createdDate,\n        industryId,\n    \t\timg,\n    \t\tlocation,\n        phoneNumber,\n   \t\t\tcity\n    \n    }\n    }");
            this.apollo.watchQuery({
              ...
              if (result && result.data && result.data.getBussinessesById) {
                _this2.bussinessList = result.data.getBussinessesById;
                _this2.bussinessListFetch = 1;
              } else {
                _this2.bussinessListFetch = -1;
              }
            });
          ...
          key: "navToProductList",
          value: function navToProductList(_bussinessId) {
      ...
      ClientListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function IHBv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LIjb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
